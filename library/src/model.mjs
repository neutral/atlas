...
export class ValidationResult {
  constructor({ profile, specificationRevision='0.9.0', complete=true, diagnostics=[], normalized=null }) {
    ...
    this.implementation={name:'atlas-reference-validator',version:'0.9.0',status:'stable'};
