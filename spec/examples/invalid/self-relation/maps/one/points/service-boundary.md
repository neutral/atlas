...
## Connection: one-service-boundary-area-scope

This record affects Scope because canonical context for service boundary.

## Connection: one-service-boundary-supports-service-boundary

Service boundary supports Service boundary because canonical context for service boundary.
