...
const membership = z.looseObject({ id: z.string(), area: z.string(), context: z.string() });
const record = z.object({
  kind: z.enum(['anchor', 'context']), map: z.string(), path: z.string(),
  title: z.string(), summary: z.string(), areas: z.array(membership), ...material, body: z.string(),
...
export const corpusSchema = z.strictObject({
  ...
  specificationRevision: z.literal('0.9.0'),
